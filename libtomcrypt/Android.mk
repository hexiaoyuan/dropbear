...
#LOCAL_CFLAGS += -O3 -Wall -DLTC_SOURCE
LOCAL_CFLAGS += -O3 -Wall

LOCAL_SRC_FILES := \
src/ciphers/aes/aes_enc.c src/ciphers/aes/aes.c src/ciphers/anubis.c src/ciphers/blowfish.c \
...
src/pk/dsa/dsa_verify_hash.c src/pk/dsa/dsa_verify_key.c \
...
src/ciphers/aes/aes_enc.c:
	echo '#define ENCRYPT_ONLY' > src/ciphers/aes/aes_enc.c
	cat src/ciphers/aes/aes.c >> src/ciphers/aes/aes_enc.c
